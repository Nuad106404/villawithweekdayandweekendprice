  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-amber-500 text-white hover:bg-amber-600 hover:text-white focus:bg-amber-500 focus:text-white dark:bg-amber-500 dark:text-white dark:hover:bg-amber-600 dark:hover:text-white dark:focus:bg-amber-500 dark:focus:text-white",
